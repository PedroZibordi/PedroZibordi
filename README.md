...
**Civil Engineer turned Software Engineer**, building full-stack products and AI-driven automation. I care about clean architecture, deterministic systems, and shipping things that solve real problems.
...
I'm part of the **development team at Nimo Energia**, working across two fronts that together drive how the company runs.
...
### Paz & Bake Doces — business website
A professional site for an artisanal confectionery business, built from a full brand identity manual.
- **Stack:** Next.js · React · TypeScript · SCSS Modules
...
Graduated in **Civil Engineering** and now working full-time in software. My background in quality assurance, project management, field engineering, and technical specifications shapes how I approach code: with an eye for process, reliability, and getting the details right. Long-term, I'm building toward tech and AI entrepreneurship.

---

## Reach me

- 📧 [pedro.zibordi@hotmail.com](mailto:pedro.zibordi@hotmail.com)
